...
async def process_line(bot, line: str):
    ...
    # 4. Hit / Kill
    if any(x in line for x in ["hit by", "killed by", "CHAR_DEBUG - KILL", "died."]):
        ...
        if "hit by" in line and 'Player "' not in line[line.find("hit by"):]:
            # Naprawiony regex – bez błędu składniowego
            ...
            if match_npc_hit:
                ...
                if is_dead:
                    ...
                    emoji = "🧟"
                    color = "[35m"   # fioletowy – zombie/infected
                    extra = f" (HP: {hp:.1f})"
